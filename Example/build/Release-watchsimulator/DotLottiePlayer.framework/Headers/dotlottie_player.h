...
uint8_t *tvg_malloc(uintptr_t size);

uint8_t *tvg_calloc(uintptr_t nmemb, uintptr_t size);

uint8_t *tvg_realloc(uint8_t *user_ptr, uintptr_t new_size);

void tvg_free(uint8_t *user_ptr);
